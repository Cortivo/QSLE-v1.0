...
echo "1) copy the 'run_qsle_parallel.sh' bash script in your working"
echo "   directory, where VERSION can be serial or parallel" 
echo "2) change the parameters in 'run_qsle_parallel.sh' following the"
echo "   instructions in the bash script"
echo "3) run the QSLE simulation with the command:"
echo "      ./run_qsle_parallel input.inp"
echo ""
